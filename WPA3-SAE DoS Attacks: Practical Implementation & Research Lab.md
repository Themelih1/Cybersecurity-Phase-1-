...
bash
    ...
    Pre-Capture Valid Values: Connect a client to the AP with an incorrect password and use Wireshark or tshark
to capture valid scalar and finite values from the SAE Commit exchange in a failed authentication attempt. Use these values in the Scapy scripts.
...
Chatzoglou, E., Kambourakis, G., & Kolias, C. (2022). How is your Wi-Fi connection today? DoS attacks on WPA3-SAE.
 Journal of Information Security and Applications, 64, 103058. https://doi.org/10.1016/j.jisa.2021.103058
